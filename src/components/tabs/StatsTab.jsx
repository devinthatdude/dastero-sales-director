...
export default function StatsTab({ leads, tags }){
  ...
  const maxSrc=Math.max(1,...Object.values(sources)), maxSvc=Math.max(1,...Object.values(services)), maxTag=Math.max(1,...Object.values(tagCounts));
